...
WallListItemV4::WallListItemV4(IrisVSTV4AudioProcessor& p, juce::Uuid id)
...
WallListItemV4::~WallListItemV4()
{
}

void WallListItemV4::resized()
{
...
void WallListItemV4::paint(juce::Graphics& g)
{
...
void WallListItemV4::buttonClicked(juce::Button* b)
{
    if (b == &deleteButton)
    {
...
void WallListItemV4::textEditorReturnKeyPressed(juce::TextEditor& ed)
{
    textEditorFocusLost(ed);
}

void WallListItemV4::textEditorFocusLost(juce::TextEditor& ed)
{
    juce::ScopedLock sl(processor.stateLock);
    for(auto& w : processor.walls) {
...
void WallListItemV4::updateFromModel()
{
    for (const auto& w : processor.walls)
    {
        if (w.id == wallId)
        {
            ...
            else nameEditor.setColour(juce::TextEditor::textColourId, Theme::textPrimary);
...
WallListComponentV4::WallListComponentV4(IrisVSTV4AudioProcessor& p)
    : processor(p)
{
...
WallListComponentV4::~WallListComponentV4()
{
}

void WallListComponentV4::resized()
{
...
void WallListComponentV4::paint(juce::Graphics& g)
{
    g.fillAll(Theme::panelBackground);
...
void WallListComponentV4::updateContent()
{
    ...
    if (structureChanged)
    {
        ...
        for (const auto& w : processor.walls)
        {
            auto item = std::make_unique<WallListItemV4>(processor, w.id);
