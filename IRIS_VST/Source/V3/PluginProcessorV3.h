...
class IrisVSTV3AudioProcessor  : public juce::AudioProcessor, public juce::Timer
{
...
public:
    ...
    void setListenerPosition(float x, float y, bool broadcast = true); // Helper called by Manager
